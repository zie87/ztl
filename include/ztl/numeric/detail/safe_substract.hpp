...
#ifndef ZTL_NUMERIC_DETAIL_SAFE_SUBSTRACT_HPP
#define ZTL_NUMERIC_DETAIL_SAFE_SUBSTRACT_HPP
...
private:
    ...
    static_assert(((min + RHS_V) <= LHS_V), "overflow in subtract");
...
template <ztl::intmax_t LHS_V, ztl::intmax_t RHS_V>
inline constexpr ztl::intmax_t safe_substract_v = safe_substract<LHS_V, RHS_V>::value;

}  // namespace ztl::detail

#endif  // ZTL_NUMERIC_DETAIL_SAFE_SUBSTRACT_HPP
